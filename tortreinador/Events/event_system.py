...
class EventType(Enum):
    ...
    VALIDATION_END = auto()
    TRAIN_COMPLETE = auto()
    GRIDSEARCH_CHECK_ALL_HYPERPARAMETERS = auto()
    GRIDSEARCH_COMPONENTS_START_LOADING = auto()
    GRIDSEARCH_COMPONENTS_LOADING_COMPLETE = auto()
    GRIDSEARCH_ROUND_SEARCH_START = auto()
    GRIDSEARCH_ROUND_SEARCH_FINISHED = auto()
